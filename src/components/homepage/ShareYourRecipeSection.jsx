    ...
    >
      <div className="container w-full flex items-center justify-between">
        <div className="flex gap-5">
          <RecipeLogoSvg />
          <p className="max-w-[700px] font-inter text-2xl font-medium leading-[150%] text-white">
        ...
        {/* share recipe button */}
        <Link className="px-6 py-3 rounded-full text-white border border-white relative">
          Share your recipe
