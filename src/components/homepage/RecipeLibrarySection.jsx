      ...
      <div className="container">
        ...
        <div className="-mt-8">
          ...
          <div className="w-full flex items-center justify-end">
            <Link className="text-textColor font-merriweather px-6 py-3 border rounded-full border-primary hover:bg-primary transition-all duration-300 hover:text-white">
              See all
            </Link>
          </div>
