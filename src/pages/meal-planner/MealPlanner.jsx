...
import { useMealPlannerCard, useMealPlannerTitleAndDesc } from '@/hooks/cms.queries';
  ...
  return (
    <div className="mt-10 md:mt-[70px] 3xl:mt-[104px]">
      ...
      <section className="container pt-20 pb-6 text-center">
        {
          mealPlannerTitleAndDesc?.map((item, idx) => <div key={idx} className="lg:px-3 xl:px-5 2xl:px-10 3xl:px-0">
            <h1 className="text-xl md:text-2xl xl:text-3xl 3xl:text-5xl font-merriweather font-bold text-black">{item?.title}</h1>
