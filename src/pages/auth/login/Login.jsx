...
const Login = () => {
  ...
  return (
    <section>
      {/* title */}
      <h4 className="text-black font-merriweather text-4xl tracking-[-0.36px] leading-[83.146px]">
        Login
      </h4>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="mt-8 space-y-6">
        ...
        <div className="w-full flex items-center justify-end">
          <Link className="text-textColor underline font-semibold hover:no-underline transition-all duration-300">
            Forgot password?
          </Link>
        </div>
      ...
      <div className="mt-12 text-center">
        <h6 className="leading-[38.375px] text-[#333]">
          ...
          <Link className="font-semibold pl-1 underline hover:no-underline transition-all duration-300">
            Create an account
          </Link>
        </h6>
      </div>
