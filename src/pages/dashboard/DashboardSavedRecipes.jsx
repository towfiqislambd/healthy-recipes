...
const DashboardSavedRecipes = () => {
    ...
    const { data: savedRecipes, isLoading: recipeLoading } = useGetWishlist(activePage, activeTab?.id);
    ...
    return (
        <section className="3xl:p-5">
            <h3 className="3xl:mb-7 text-xl 2xl:text-2xl text-[#E48E19] font-semibold font-merriweather">Your favorite recipes</h3>
            ...
            <div className="grid md:grid-cols-2 2xl:grid-cols-3 4xl:grid-cols-4 gap-5 3xl:px-5 2xl:px-0">
                {
                    savedRecipes?.wishlist?.data.length > 0 ?
                        ...
                        <div className="text-center col-span-4 py-6 space-y-3">
                            ...
                            <p className="text-primary font-merriweather md:text-lg">No favorite recipes found</p>
                        </div>
                }
            </div>
