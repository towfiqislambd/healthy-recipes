  ...
  return (
    <div className="max-w-[752px] mx-auto sm:py-3 2xl:py-8">
      <div
        ...
        className="flex mb-3 items-center gap-2 text-[#373E85] group cursor-pointer"
      >
      ...
      >
        ...
        <div>
          ...
          {customErrors.recipe_video && (
            <p className="text-red-500 mt-2">{customErrors.recipe_video}</p>
          )}
        </div>
